package net.supgamernl.bnm;

import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.LogManager;

import net.supgamernl.bnm.init.BnmModTabs;
...
@Mod("bnm")
public class BnmMod {
	public static final Logger LOGGER = LogManager.getLogger(BnmMod.class);
	public static final String MODID = "bnm";

	public BnmMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		BnmModItems.REGISTRY.register(modEventBus);
		BnmModTabs.REGISTRY.register(modEventBus);
